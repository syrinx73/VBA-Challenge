...
' data to be %
        ...
        For m = 2 To ActiveWorkbook.Worksheets(i).Range("K1").CurrentRegion.Rows.Count
            If ActiveWorkbook.Worksheets(i).Cells(m, 12).Value = ActiveWorkbook.Worksheets(i).Cells(4, 17).Value Then
                ActiveWorkbook.Worksheets(i).Cells(4, 16).Value = ActiveWorkbook.Worksheets(i).Cells(m, 9).Value
            ElseIf ActiveWorkbook.Worksheets(i).Cells(m, 11).Value = ActiveWorkbook.Worksheets(i).Cells(2, 17).Value Then
